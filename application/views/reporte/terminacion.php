        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Reporte <small>Generación de reporte de Liquidación.</small></h5>
                ...
                <!--FORMULARIO -->
                <?php echo form_open('/reporte/terminacion/generar', array('id' => 'frmterminacion', 'enctype' => 'multipart/form-data')); ?>
