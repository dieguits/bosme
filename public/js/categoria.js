...
$(document).ready(function() {
    ...
    var table = $("#dtcategorias").DataTable({
        ...
        //"paging": true,
        "ajax": {
            "url": "../categoria/categoria/obtenerCategorias",
            "type": "POST"
        },
        //"data": obj.servicios,
        "columns": [
     ...
     */
    $('#dtcategorias tbody').on('click', 'a', function() {
        var enlace = $(this);
    ...
    $("#guardar").click(function(e) {
        ...
        if (validarCampos()) {
            ...
            if ($("#guardar").val() === 'Guardar') {
                $.post(
                        "../categoria/categoria/guardarCategoria",
                        {
                            cod: $("#codigo").val(),
                            descri: $("#descri").val(),
                            activo: $("#activo").val()
                ...
                $.post(
                        "../categoria/categoria/actualizarCategoria",
                        {
                            cod: $("#codigo").val(),
                            cod_old: $("#cod_old").val(),
                            descri: $("#descri").val(),
